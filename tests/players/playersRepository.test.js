...
describe('PLAYER Repository', () => {
    ...
    beforeEach(() => {
        return h.clear(Player)
            ...
            .then(() => h.clear(Game)
                .then(() => Game.create([
                    {
                        _id: gameIds[0], place: 'Milos', datetime: '2017-01-01', notes: 'Cool game', players: [
                        {
                            player: playerIds[0],
                    ...
                    {
                        _id: gameIds[1], place: 'Gyzi', datetime: '2017-01-02', notes: 'Cool game', players: [
                        {
                            player: playerIds[0],
                    ...
                    {
                        _id: gameIds[2], place: 'Peristeri', datetime: '2017-01-03', notes: 'Cool game', players: [
                        {
                            player: playerIds[0],
            ...
            .then(() => {
                return Player.findByIdAndUpdate(playerIds[0], {games: gameIds}, () => {
                    return Player.findByIdAndUpdate(playerIds[1], {games: gameIds}, () => {
                        return Player.findByIdAndUpdate(playerIds[2], {games: gameIds}, () => {
                            return 'ok'
                        })
                    })
                })
    ...
    describe('#getRankings', () => {
        it('should find and return the player of given nickname', async () => {
            ...
            const player = await repo.getRankings('Mr.Crabs');
